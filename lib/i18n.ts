export const translations = {
  en: {
    ...
    "admin.ragSection.subtitle": "Manage existing knowledge bases. Use the button above to create new ones.",
    ...
    "adminRag.docs.instructions": "Accepted formats: PDF, DOCX, TXT, ODT, ODS, or ODP. Maximum size is enforced by the backend.",
    "adminRag.docs.unavailable": "Documents become available once the RAG is provisioned.",
    "adminRag.errors.metadataUnavailable": "RAG metadata unavailable.",
    "adminRag.errors.selectFiles": "Select at least one PDF, DOCX, TXT, ODT, ODS, or ODP file to upload.",
    ...
    "adminRag.sections.documentsDescription": "Upload documents (PDF, DOCX, TXT, ODT, ODS, ODP) to enrich the knowledge base.",
    ...
    "adminCreate.documentsHelp": "PDF, DOCX, TXT, ODT, ODS, or ODP. You can upload more later from the manage view.",
    ...
    "adminCreate.sections.documentsDescription": "Upload optional PDF, DOCX, TXT, ODT, ODS, or ODP files to ingest immediately after creation.",
  ...
  fr: {
    ...
    "adminRag.docs.instructions": "Formats acceptés : PDF, DOCX, TXT, ODT, ODS ou ODP. La taille maximale est contrôlée par le backend.",
    "adminRag.docs.unavailable": "Les documents deviennent disponibles une fois que le RAG est provisionné.",
    "adminRag.errors.metadataUnavailable": "Métadonnées du RAG indisponibles.",
    "adminRag.errors.selectFiles": "Sélectionnez au moins un fichier PDF, DOCX, TXT, ODT, ODS ou ODP à téléverser.",
    ...
    "adminRag.sections.documentsDescription": "Téléversez des documents (PDF, DOCX, TXT, ODT, ODS, ODP) pour enrichir la base de connaissances.",
    ...
    "adminCreate.descriptionLabel": "Description",
    "adminCreate.documentsLabel": "Documents",
    "adminCreate.documentsHelp": "PDF, DOCX, TXT, ODT, ODS ou ODP. Vous pourrez en ajouter d’autres depuis la vue de gestion.",
    ...
    "adminCreate.sections.documentsTitle": "Documents",
    "adminCreate.sections.documentsDescription": "Téléversez des fichiers PDF, DOCX, TXT, ODT, ODS ou ODP optionnels qui seront ingérés immédiatement après la création.",
