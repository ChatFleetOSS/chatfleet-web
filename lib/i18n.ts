export const translations = {
  en: {
    ...
    "assistant.error.noContext": "No supporting snippets were found. Try rephrasing or uploading documents for this assistant.",
    ...
    "publicRag.description.missing": "This assistant is public. Start chatting to explore its knowledge.",
    "publicRag.prompt.title": "Ask your question",
    "publicRag.prompt.subtitle": "Describe what you need. The suggestions below can help you start.",
    "publicRag.composer.placeholder": "e.g., How do I declare and manipulate arrays in Perl?",
    "publicRag.suggestions.title": "Suggestions",
    "publicRag.suggestions.q1": "What are the core concepts covered here?",
    "publicRag.suggestions.q2": "Can you summarize the key steps to get started?",
    ...
    "admin.header.subtitle": "Review runtime settings, users, and RAG workspaces from one place.",
    "admin.runtime.title": "Runtime configuration",
    "admin.runtime.description": "Review the values currently applied to the runtime.",
    ...
    "adminRag.docs.instructions": "Accepted formats: PDF, DOCX, ODT, or TXT. Maximum size is enforced by the backend.",
    ...
    "adminRag.errors.selectFiles": "Select at least one PDF, DOCX, ODT, or TXT file to upload.",
    ...
    "adminRag.sections.documentsDescription": "Upload documents (PDF, DOCX, ODT, TXT) to enrich the knowledge base.",
    ...
    "adminRag.sections.metadataDescription": "Review key attributes for this RAG instance.",
    "adminRag.sections.documentsDescription": "Upload PDFs, DOCX, ODT, or TXT to enrich the knowledge base.",
    "adminRag.sections.indexDescription": "Run maintenance jobs to refresh or reset embeddings.",
    "adminRag.sections.usersDescription": "Manage who can access this assistant.",
    "adminRag.sections.catalogDescription": "Track ingestion state and indexed chunks for each document.",
    ...
    "adminCreate.documentsHelp": "PDF, DOCX, ODT, or TXT. You can upload more later from the manage view.",
    ...
    "adminCreate.sections.documentsDescription": "Upload optional PDF, DOCX, ODT, or TXT files to ingest immediately after creation.",
    "adminCreate.visibilityLabel": "Visibility",
    "adminCreate.visibilityHelp": "Public assistants are chat-accessible without signing in. Uploads and admin actions remain restricted to admins.",
    ...
    "adminCreate.processingBody": "We’re creating “{{name}}” and indexing your documents right now.",
    "adminCreate.processingProgress": "Indexing documents… {{progress}}%",
    "adminCreate.processingSubtitle": "Stay on this page to follow ingestion. We’ll keep you posted.",
    ...
    "adminCreate.successBody": "RAG “{{name}}” is ready. You can jump into the detail view to review indexing.",
    "adminCreate.successCta": "Go to RAG",
    "adminCreate.errorTitle": "Couldn’t create the RAG",
    "adminCreate.errorBody": "Something went wrong during creation. Please try again or check the logs.",
    ...
    "adminSettings.baseUrlHelp": "Point to your vLLM OpenAI-compatible base, e.g. http://localhost:8001/v1.",
    "adminSettings.apiKey": "API key",
    "adminSettings.apiKeyPlaceholder": "Enter your API key (will be encrypted)",
    "adminSettings.apiKeyHelpOpenai": "Required for OpenAI requests. Stored encrypted; never shown.",
    "adminSettings.apiKeyHelpVllm": "Optional for vLLM if your endpoint requires auth. Stored encrypted; never shown.",
    ...
    "adminSettings.modelsEmpty": "No models returned. Check the base URL and provider.",
    "adminSettings.modelsHintVllm": "Enter the model IDs exposed by vLLM, or refresh to discover them.",
    ...
    "adminSettings.embedProviderHelp": "Choose whether embeddings run locally or via OpenAI.",
    "adminSettings.localEmbedHelp": "Runs locally using sentence-transformers; downloads weights on first use.",
    ...
    "adminSettings.requiredFields": "Fill in the required provider fields to test and save.",
    "admin.runtime.chatModel": "Chat model",
    "admin.runtime.embeddingModel": "Embedding model",
  },
  fr: {
    ...
    "assistant.sourcesEntry": "{{position}}. {{filename}} · pages {{pages}}",
    "assistant.error.noContext": "Aucun extrait pertinent n’a été trouvé. Reformulez votre question ou ajoutez des documents pour cet assistant.",
    "thread.suggestionGroupLabel": "Questions suggérées",
    "publicRag.list.title": "Assistants publics",
    "publicRag.list.subtitle": "Tout le monde peut ouvrir et chatter avec ces assistants — sans connexion.",
    ...
    "publicRag.description.missing": "Cet assistant est public. Commencez à discuter pour explorer son contenu.",
    "publicRag.prompt.title": "Posez votre question",
    "publicRag.prompt.subtitle": "Décrivez ce que vous cherchez. Les suggestions ci-dessous peuvent vous inspirer.",
    "publicRag.composer.placeholder": "Ex : Comment déclarer et manipuler des tableaux en Perl ?",
    "publicRag.suggestions.title": "Suggestions",
    ...
    "publicRag.suggestions.q3": "Comment travailler avec les tableaux dans ce guide ?",
    ...
    "adminRag.docs.instructions": "Formats acceptés : PDF, DOCX, ODT ou TXT. La taille maximale est contrôlée par le backend.",
    ...
    "adminRag.errors.selectFiles": "Sélectionnez au moins un fichier PDF, DOCX, ODT ou TXT à téléverser.",
    ...
    "adminRag.visibility.private": "Privé (seuls les utilisateurs partagés peuvent chatter)",
    "adminRag.visibility.public": "Public (toute personne avec le lien peut chatter)",
    ...
    "adminRag.sections.documentsDescription": "Téléversez des documents (PDF, DOCX, ODT, TXT) pour enrichir la base de connaissances.",
    ...
    "adminCreate.descriptionLabel": "Description",
    "adminCreate.documentsLabel": "Documents",
    "adminCreate.documentsHelp": "PDF, DOCX, ODT ou TXT. Vous pourrez en ajouter d’autres depuis la vue de gestion.",
    ...
    "adminCreate.sections.documentsTitle": "Documents",
    "adminCreate.sections.documentsDescription": "Téléversez des fichiers PDF, DOCX, ODT ou TXT optionnels qui seront ingérés immédiatement après la création.",
    "adminCreate.visibilityLabel": "Visibilité",
    "adminCreate.visibilityHelp": "Les assistants publics sont accessibles en chat sans connexion. Les téléversements et actions admin restent réservés aux administrateurs.",
    ...
    "adminCreate.processingBody": "Nous créons « {{name}} » et indexons vos documents en ce moment.",
    "adminCreate.processingProgress": "Indexation des documents… {{progress}} %",
    "adminCreate.processingSubtitle": "Restez sur cette page pour suivre l’ingestion. Nous vous tenons informé.",
    ...
    "adminCreate.successBody": "Le RAG « {{name}} » est prêt. Accédez à sa fiche pour revoir l’indexation.",
    "adminCreate.successCta": "Aller au RAG",
    "adminCreate.errorTitle": "Impossible de créer le RAG",
    "adminCreate.errorBody": "Une erreur est survenue lors de la création. Réessayez ou vérifiez les journaux.",
    ...
    "adminSettings.baseUrlHelp": "Pointez vers la base OpenAI‑compatible de vLLM, ex. http://localhost:8001/v1.",
    "adminSettings.apiKey": "Clé API",
    "adminSettings.apiKeyPlaceholder": "Saisissez votre clé API (sera chiffrée)",
    "adminSettings.apiKeyHelpOpenai": "Requise pour OpenAI. Stockée chiffrée ; jamais affichée.",
    "adminSettings.apiKeyHelpVllm": "Optionnelle pour vLLM si votre endpoint exige une auth. Stockée chiffrée ; jamais affichée.",
    ...
    "adminSettings.modelsEmpty": "Aucun modèle retourné. Vérifiez l’URL de base et le fournisseur.",
    "adminSettings.modelsHintVllm": "Renseignez les IDs de modèles exposés par vLLM, ou actualisez-les.",
    "adminSettings.embedProvider": "Source des embeddings",
    "adminSettings.embedProviderOpenai": "API OpenAI",
    "adminSettings.embedProviderLocal": "Local (sentence-transformers)",
    "adminSettings.embedProviderHelp": "Choisissez si les embeddings tournent en local ou via OpenAI.",
    "adminSettings.localEmbedHelp": "Exécution locale avec sentence-transformers ; téléchargement au premier usage.",
    ...
    "adminSettings.requiredFields": "Renseignez les champs requis pour tester et enregistrer.",
  },
} as const;
