export const translations = {
  en: {
    ...
    "adminRag.docs.instructions": "Accepted formats: PDF, DOCX, or TXT. Maximum size is enforced by the backend.",
    ...
    "adminRag.errors.selectFiles": "Select at least one PDF, DOCX, or TXT file to upload.",
    ...
    "adminRag.sections.documentsDescription": "Upload documents (PDF, DOCX, TXT) to enrich the knowledge base.",
    ...
    "adminCreate.documentsHelp": "PDF, DOCX, or TXT. You can upload more later from the manage view.",
    ...
    "adminCreate.sections.documentsDescription": "Upload optional PDF, DOCX, or TXT files to ingest immediately after creation.",
  ...
  fr: {
    ...
    "adminRag.docs.instructions": "Formats acceptés : PDF, DOCX ou TXT. La taille maximale est contrôlée par le backend.",
    ...
    "adminRag.errors.selectFiles": "Sélectionnez au moins un fichier PDF, DOCX ou TXT à téléverser.",
    ...
    "adminRag.sections.documentsDescription": "Téléversez des documents (PDF, DOCX, TXT) pour enrichir la base de connaissances.",
    ...
    "adminCreate.descriptionLabel": "Description",
    "adminCreate.documentsLabel": "Documents",
    "adminCreate.documentsHelp": "PDF, DOCX ou TXT. Vous pourrez en ajouter d’autres depuis la vue de gestion.",
    ...
    "adminCreate.sections.documentsTitle": "Documents",
    "adminCreate.sections.documentsDescription": "Téléversez des fichiers PDF, DOCX ou TXT optionnels qui seront ingérés immédiatement après la création.",
